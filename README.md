...
$$
L_{\text{drift}} = \frac{2 V_B}{E_{\text{crit}}} \quad [\mathrm{cm}]
$$

$$
R_{\mathrm{on, drift}} = \frac{L_{\mathrm{drift}}}{q \mu_n N_D A} \quad [\Omega]
$$

### Answer

$$
R_{\mathrm{on, drift}} = 163.333 \ \mathrm{m}\Omega \cdot \mathrm{cm}^2
$$
